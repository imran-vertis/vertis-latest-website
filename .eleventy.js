...
const globalSiteData = {
  title: "Vertis Website",
  description: "New Vertis Website",
  locale: 'en',
  baseUrl: baseUrl,
...
module.exports = function (eleventyConfig) {
  ...
  return {
    dir: {
      input: "src",
      output: "_site",
      includes: "includes", // this path is relative to input-path (src/)
      layouts: "layouts", // this path is relative to input-path (src/)
      data: "data", // this path is relative to input-path (src/)
    },
